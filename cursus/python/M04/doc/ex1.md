...
Mission Briefing: Excellent work on the data recovery! Your next assignment is to establish a new preservation protocol by creating fresh archive entries.

Use the code created for the previous exercise. At the end of the script, improve the code to:

- Add a special archive character (the # character) at the end of each line (let's say, to be 2087-compatible)
